...
from django_willpower.logger import init_logger

from django_willpower.cli.version import version_command
from django_willpower.cli.greet import greet_command
...
def cli_frontend(ctx, verbose):
    """
    Sample tool for django-willpower
    """
    printout = True
    if verbose == 0:
        verbose = 1
